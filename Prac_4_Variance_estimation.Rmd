...
date: Exercise 4. Variance estimation for systematic survey designs <br> September 2020
output: 
...
est.boot <- bootdht(model=sysvar2.hn, flatfile=Systematic_variance_2,
                    ...
                    convert.units=conversion.factor, nboot=199)
```
...
Fewster RM, Buckland ST, Burnham KP, Borchers DL, Jupp PE, Laake JL and Thomas L (2009) Estimating the encounter rate in distance sampling. Biometrics 65:225-236 https://doi.org/10.1111/j.1541-0420.2008.01018.x
